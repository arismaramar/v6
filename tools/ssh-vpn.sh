...
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/arismaramar/v6/main/tools/password"
...
wget -q -O /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/arismaramar/v6/main/tools/ws-dropbear"
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/arismaramar/v6/main/tools/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/arismaramar/v6/main/tools/newudpgw"
...
# Install Stunnel5
cd /root/
wget -q "https://raw.githubusercontent.com/arismaramar/v6/main/tools/stunnel5.zip"
unzip stunnel5.zip
cd /root/stunnel
chmod +x configure
./configure
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/arismaramar/v6/main/tools/stunnel5.init"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/arismaramar/v6/main/issue.net"
