...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/arismaramar/v6/main/backup/rclone.conf"
...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/arismaramar/v6/main/backup/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/arismaramar/v6/main/backup/restore.sh" && chmod +x /usr/bin/restore
