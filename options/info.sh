...
Isadmin=$(curl -sS https://raw.githubusercontent.com/arismaramar/izin/main/ip | grep $MYIP | awk '{print $5}')
...
echo -e "└──────────────────────────────────────────┘" | lolcat
echo -e "\033[1;96m  Owner        : ANGGUN TUNNEL \e[0m"
echo -e "\033[1;96m  Contact WA   : 085365581599 \e[0m"
echo -e "\033[1;96m  Telegram     : t.me/amantubilah \e[0m"
